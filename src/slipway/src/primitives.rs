...
const MAXIMUM_API_KEY_NAME_LENGTH: usize = 256;
...
slipway_engine::utils::create_validated_string_struct!(pub ApiKeyName, Some(slipway_engine::SLIPWAY_ALPHANUMERIC_NAME_REGEX_STR), Some(1), MAXIMUM_API_KEY_NAME_LENGTH);
